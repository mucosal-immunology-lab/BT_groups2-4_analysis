...
notebook.name <- 'breathing_together_metagenomics'
...
base_fp <- here('input', '01_Metagenomics', '01_Anvio', 'mapping', 'alignment_counts')
...
contig_df <- data.frame('contig_id' = rownames(alignment_counts)) %>%
  left_join(read_csv(here('input', '01_Metagenomics', '01_Anvio', 'external-binning-results', 'contigs-fixed-BusyBee',
...
saveRDS(contaminant_ratios, here('output', '01_Metagenomics', '01_Decontamination', 'contamination_ratios_data.rds'))
...
saveRDS(contig_data_clean, here('output', '01_Metagenomics', '01_Decontamination', 'contig_data_clean.rds'))
```
...
contigs_fixed <- phylotools::read.fasta(file = here('input', '01_Metagenomics', '01_Anvio', 'contigs-fixed.fa'))
...
saveRDS(contigs_fixed, here('output', '01_Metagenomics', '01_Decontamination', 'contigs_fixed_fasta_df.rds'))

# Rewrite the contigs back to FASTA format
phylotools::dat2fasta(contigs_fixed, here('input', '01_Metagenomics', '01_Anvio', 'contigs-clean.fa'))
```
...
contig_data_clean <- readRDS(here('output', '01_Metagenomics', '01_Decontamination', 'contig_data_clean.rds'))
...
saveRDS(contig_data_contam90, here('output', '01_Metagenomics', '01_Decontamination', 'contig_data_contam90.rds'))
```
...
contig_data_contam90 <- readRDS(here('output', '01_Metagenomics', '01_Decontamination', 'contig_data_contam90.rds'))

# Import GhostKOALA data
gk_raw_90 <- read_tsv(here('input', '01_Metagenomics', '01_Anvio', 'contam90', 'ghostkoala', 'ghost-koala-results-contam90.txt')) %>%
...
# Save the RDS
saveRDS(contig_data_contam90_gk, here('input', '01_Metagenomics', '02_GhostKoala', '01_PhyloseqObjects', 'contig_data_contam90_gk.rds'))
```
...
contig_data_contam90_gk <- readRDS(here('input', '01_Metagenomics', '02_GhostKoala', '01_PhyloseqObjects', 'contig_data_contam90_gk.rds'))
...
saveRDS(contig_glom_contam90_gk, here('input', '01_Metagenomics', '02_GhostKoala', '01_PhyloseqObjects', 'contig_glom_contam90_gk.rds'))
```
...
contig_glom_contam90_gk <- readRDS(here('input', '01_Metagenomics', '02_GhostKoala', '01_PhyloseqObjects', 'contig_glom_contam90_gk.rds'))
...
saveRDS(metaG_CLR, here('input', '01_Metagenomics', '02_GhostKoala', '01_PhyloseqObjects', 'metaG_CLR.rds'))
```
...
```{r}
# Retrieve datasets
metaG_CLR <- readRDS(here('input', '01_Metagenomics', '02_GhostKoala', '01_PhyloseqObjects', 'metaG_CLR.rds'))
...
saveRDS(metaG_CLR_matrix, here('input', '06_MOFA', 'metaG_CLR_matrix.rds'))
```